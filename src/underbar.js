(function() {
  ...
  _.uniq = function(array) { //[1,2,1,2,3,1] => [1,2,3]
    var unique = [];
  ...
  _.delay = function(func, wait) {
    ...
    //args is now index 2 and beyond from the arguments object
    //similar to ->  args = arguments.slice(2);
    return setTimeout(function(){ 
    //first argument of setTimeout must be a function
  ...
  _.shuffle = function(array) {
    ...
    while (randomNumArray.length < array.length){
      var randomNum = Math.floor(Math.random() * array.length);
      if (_.indexOf(randomNumArray, randomNum) === -1){
        randomNumArray.push(randomNum);
      }
    }

    var i = 0;
    _.each(randomNumArray, function(num){
      shuffled[num] = array[i];
      i++;
    });
    return shuffled;
  };
